...
describe('Skip validation for strict unchanged value constraint:', () => {
  const testFixture = testFixtureMaker.initFromValidationFunction(
    'build/validation-functions/test-skip-validation-when-value-unchanged-strict-validation-function.js');
  ...
  describe('with static validation', () => {
    it('allows document creation with valid values', () => {
      const doc = {
        _id: 'my-doc',
        type: 'staticSkipValidationWhenValueUnchangedStrictDoc',
        integerProp: 49,
        floatProp: -153.9,
        stringProp: 'a-string',
        booleanProp: true,
    ...
    it('allows document replacement with invalid values that strictly equal the original values', () => {
      const oldDoc = {
        _id: 'my-doc',
        type: 'staticSkipValidationWhenValueUnchangedStrictDoc',
        integerProp: -1,
    ...
    it('rejects document replacement with invalid values that semantically equal the original values', () => {
      const oldDoc = {
        _id: 'my-doc',
        type: 'staticSkipValidationWhenValueUnchangedStrictDoc',
        integerProp: -1,
  ...
  describe('with dynamic validation', () => {
    ...
    it('allows document replacement with strictly equal invalid values when validation is allowed to be skipped', () => {
      const oldDoc = {
        _id: 'my-doc',
        type: 'dynamicSkipValidationWhenValueUnchangedStrictDoc',
        allowValidationSkip: true,
    ...
    it('rejects document replacement with semantically equal invalid values when validation is allowed to be skipped', () => {
      const oldDoc = {
        _id: 'my-doc',
        type: 'dynamicSkipValidationWhenValueUnchangedStrictDoc',
        allowValidationSkip: true,
        uuidProp: 'EC8EE255-CF77-46C6-B935-12A0DC5E8942'
      };
      ...
      const doc = {
        ...
        type: 'dynamicSkipValidationWhenValueUnchangedStrictDoc',
        uuidProp: 'ec8ee255-cf77-46c6-b935-12a0dc5e8942',
        minimumUuidValue: 'F0000000-0000-0000-0000-000000000000'
      };
      ...
      testFixture.verifyDocumentNotReplaced(
        ...
        oldDoc,
        'dynamicSkipValidationWhenValueUnchangedStrictDoc',
        [ errorFormatter.minimumValueViolation('uuidProp', 'F0000000-0000-0000-0000-000000000000') ]);
    });
