...
/**
 * Creates a stubbed CouchDB environment for document definitions or a validation function for use in tests, schema
 * validation, etc.
 *
...
exports.create = function(templateFile, macroName, sourceContents, sourceFile) {
  ...
  // Compile the environment within the current virtual machine context so it can share access to the "isArray",
  // "toJSON", etc. stubs as defined by the template
